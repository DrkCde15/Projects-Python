...
7  - Instalar via Chocolatey (choco)
8  - Alterar senha de um usuário
9  - Adicionar chave ao Registro (reg add)
10 - Alterar configurações do sistema
11 - Rodar scanner de portas (nmap)
12 - Rodar antivírus (Windows Defender)
13 - Atualizar o Windows
14 - Sair
""")
